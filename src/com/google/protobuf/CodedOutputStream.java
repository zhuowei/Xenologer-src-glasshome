...
public final class CodedOutputStream
{
  ...
  {
    return 2 * computeTagSize(paramInt) + computeGroupSizeNoTag(paramMessageLite);
  }
  ...
  {
    return 2 * computeTagSize(1) + computeUInt32Size(2, paramInt) + computeLazyFieldSize(3, paramLazyField);
  }
  ...
  {
    return 2 * computeTagSize(1) + computeUInt32Size(2, paramInt) + computeMessageSize(3, paramMessageLite);
  }
    ...
    throws IOException
  {
    ...
    this.totalBytesWritten = (1 + this.totalBytesWritten);
  }
    ...
    throws IOException
  {
    if (this.limit - this.position >= paramInt2)
    {
      ...
      this.totalBytesWritten = (paramInt2 + this.totalBytesWritten);
      return;
    }
    ...
    if (k <= this.limit)
    {
      ...
      this.position = k;
      this.totalBytesWritten = (k + this.totalBytesWritten);
      return;
    }
    ...
    do
    {
      ...
      this.totalBytesWritten = (n + this.totalBytesWritten);
      k -= n;
      if (k <= 0)
        break;
