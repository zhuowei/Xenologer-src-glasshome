...
public final class DynamicMessage extends AbstractMessage
{
  ...
  DynamicMessage(Descriptors.Descriptor paramDescriptor, FieldSet<Descriptors.FieldDescriptor> paramFieldSet, UnknownFieldSet paramUnknownFieldSet)
  {
  ...
  public int getSerializedSize()
  {
    ...
    for (int j = this.fields.getMessageSetSerializedSize() + this.unknownFields.getSerializedSizeAsMessageSet(); ; j = this.fields.getSerializedSize() + this.unknownFields.getSerializedSize())
    {
      this.memoizedSize = j;
      return j;
    }
  ...
  public DynamicMutableMessage mutableCopy()
  {
    return new DynamicMutableMessage(this.type, this.fields.cloneWithAllFieldsToMutable(), this.unknownFields);
  }
