...
public final class CodedInputStream
{
    ...
    throws IOException
  {
    ...
    {
      byte[] arrayOfByte = Arrays.copyOfRange(this.buffer, this.bufferPos, i + this.bufferPos);
    ...
    throws IOException
  {
    ...
    MessageLite localMessageLite = (MessageLite)paramParser.parsePartialFrom(this, paramExtensionRegistryLite);
    ...
    throws IOException
  {
    if (this.recursionDepth >= this.recursionLimit)
      throw InvalidProtocolBufferException.recursionLimitExceeded();
    this.recursionDepth = (1 + this.recursionDepth);
    paramMutableMessageLite.mergePartialFrom(this, paramExtensionRegistryLite);
    checkLastTagWas(WireFormat.makeTag(paramInt, 4));
    this.recursionDepth = (-1 + this.recursionDepth);
  }
