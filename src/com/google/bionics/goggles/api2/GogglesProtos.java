...
public final class GogglesProtos
{
  ...
  public static final class Result extends MessageMicro
  {
    ...
    public int getSerializedSize()
    {
      ...
      if (hasPeanut())
        i += CodedOutputStreamMicro.computeMessageSize(10, getPeanut());
      if (hasSearchCorpus())
    ...
    public Result setPeanut(PeanutProtos.Peanut paramPeanut)
    {
      if (paramPeanut == null)
        throw new NullPointerException();
      this.hasPeanut = true;
      this.peanut_ = paramPeanut;
      return this;
    }
      ...
      throws IOException
    {
      ...
      if (hasPeanut())
        paramCodedOutputStreamMicro.writeMessage(10, getPeanut());
      if (hasSearchCorpus())
