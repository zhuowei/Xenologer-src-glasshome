...
{
  public HorizontalScrollImageView(Context paramContext)
  {
    super(paramContext);
  }

  public HorizontalScrollImageView(Context paramContext, AttributeSet paramAttributeSet)
  {
    super(paramContext, paramAttributeSet);
  }

  public HorizontalScrollImageView(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
 ...
 * Qualified Name:     com.google.glass.horizontalscroll.HorizontalScrollImageView
