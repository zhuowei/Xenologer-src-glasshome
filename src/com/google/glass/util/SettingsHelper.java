...
public class SettingsHelper
{
  ...
  {
    TimelineItemId localTimelineItemId = new TimelineItemId(TimelineItem.newBuilder().setId(createSettingsItemId(0)).build());
    TimelineHelper.goToTimeline(this.context, localTimelineItemId);
  }
