  ...
  implements RetryPolicy
{
  ...
  public RetryPolicyImpl(Supplier<GstaticConfiguration.NetworkRecognizer> paramSupplier)
  {
  ...
  public boolean canRetry(RecognizeException paramRecognizeException)
  {
    try
    {
      ...
      while (true)
      {
        ...
        if (this.recognitionStartedTimestamp + this.maxRetryTimeoutMsec < System.currentTimeMillis())
        {
  ...
  public void reset()
  {
    ...
    {
      this.counter = -1;
      this.recognitionStartedTimestamp = System.currentTimeMillis();
      return;
    }
    finally
    {
