...
public class OptionMenu
{
  ...
  private void addItem(Item paramItem)
  {
  ...
  private static OptionMenu inflateFrom(OptionMenu paramOptionMenu, int paramInt)
  {
    ...
    //   1: astore_2
    //   2: aload_0
    //   3: getfield 34	com/google/glass/widget/OptionMenu:context	Landroid/content/Context;
    //   6: invokevirtual 57	android/content/Context:getResources	()Landroid/content/res/Resources;
    //   9: iload_1
    //   10: invokevirtual 63	android/content/res/Resources:getXml	(I)Landroid/content/res/XmlResourceParser;
    //   13: astore_2
    //   14: aload_0
    //   15: aload_2
    //   16: aload_2
    //   17: invokestatic 69	android/util/Xml:asAttributeSet	(Lorg/xmlpull/v1/XmlPullParser;)Landroid/util/AttributeSet;
    //   20: invokestatic 73	com/google/glass/widget/OptionMenu:parseMenu	(Lcom/google/glass/widget/OptionMenu;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;)Lcom/google/glass/widget/OptionMenu;
    //   23: astore 6
    //   25: aload_2
    //   26: ifnull +9 -> 35
    //   29: aload_2
    ...
    //   37: areturn
    //   38: astore 5
    //   40: new 80	android/view/InflateException
    //   43: dup
    //   44: ldc 82
    //   46: aload 5
    //   48: invokespecial 85	android/view/InflateException:<init>	(Ljava/lang/String;Ljava/lang/Throwable;)V
    //   51: athrow
    //   52: astore 4
    //   54: aload_2
    //   55: ifnull +9 -> 64
    ...
    //   66: athrow
    //   67: astore_3
    //   68: new 80	android/view/InflateException
    //   71: dup
    //   72: ldc 82
    //   74: aload_3
    //   75: invokespecial 85	android/view/InflateException:<init>	(Ljava/lang/String;Ljava/lang/Throwable;)V
    //   78: athrow
    //
    // Exception table:
    //   from	to	target	type
  ...
  private void insertItem(int paramInt, Item paramItem)
  {
  ...
  private static Item parseItem(Context paramContext, XmlPullParser paramXmlPullParser, AttributeSet paramAttributeSet)
  {
    ...
    Item localItem = new Item(i, localCharSequence, localDrawable, null);
    ...
    throws XmlPullParserException, IOException
  {
    ...
    Item localItem = new Item(i, null);
    ...
    if (j != 1)
    {
      ...
      while (true)
      {
        ...
        break;
        label174: skipCurrentTag(paramXmlPullParser);
      }
    }
  ...
  {
    addItem(new Item(paramInt, paramString, null, null));
  }
  ...
  public void addItem(int paramInt1, String paramString, int paramInt2)
  {
    ...
    {
      addItem(new Item(paramInt1, paramString, localDrawable, null));
      return;
    }
  }
  ...
  {
    addItem(new Item(paramInt, paramString, new BitmapDrawable(paramBitmap), null));
  }

  public void addItem(int paramInt, ItemState[] paramArrayOfItemState)
  {
    Item localItem = new Item(paramInt, null);
  ...
  {
    insertItem(paramInt1, new Item(paramInt2, paramString, this.context.getResources().getDrawable(paramInt3), null));
  }
  ...
  public static class Item
  {
    ...
    private Item(int paramInt, CharSequence paramCharSequence, Drawable paramDrawable)
    {
      this(paramInt);
