...
public class AudioController
{
  ...
  public AudioController(Context paramContext, SpeechSettings paramSpeechSettings, SpeechLevelSource paramSpeechLevelSource, SpeechSoundManager paramSpeechSoundManager, int paramInt, Supplier<Integer> paramSupplier, AudioRouter paramAudioRouter, SpeechLibLogger paramSpeechLibLogger)
  {
  ...
  public void startListening(RecognitionEventListener paramRecognitionEventListener)
  {
    try
    {
      if (!this.mListening)
      {
        ...
        this.mAudioManager.requestAudioFocus(this.mAudioFocusChangeListener, this.mAudioStream, 2);
        this.mLogger.logAudioPathEstablished(((Integer)this.mAudioRoutingSupplier.get()).intValue());
        if (this.mAudioSource != null)
          this.mAudioSource.start(paramRecognitionEventListener);
        this.mAudioRouter.start();
