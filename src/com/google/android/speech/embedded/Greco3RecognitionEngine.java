  ...
  implements RecognitionEngine
{
  ...
  public Greco3RecognitionEngine(@Nonnull Greco3EngineManager paramGreco3EngineManager, @Nonnull SpeechLevelSource paramSpeechLevelSource, int paramInt1, int paramInt2, @Nonnull SpeechSettings paramSpeechSettings, @Nonnull Greco3CallbackFactory paramGreco3CallbackFactory, @Nonnull Greco3ModeSelector paramGreco3ModeSelector, @Nonnull GrecoEventLogger.Factory paramFactory)
  {
