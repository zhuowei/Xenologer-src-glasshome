...
public class Greco3DataManager
{
  ...
  @VisibleForTesting
  public Greco3DataManager(Context paramContext, @Nullable Greco3Preferences paramGreco3Preferences, int paramInt, ImmutableList<File> paramImmutableList, @Nullable File paramFile, Executor paramExecutor)
  {
  ...
  public Greco3DataManager(Context paramContext, Greco3Preferences paramGreco3Preferences, int paramInt, Executor paramExecutor)
  {
    this(paramContext, paramGreco3Preferences, paramInt, getSearchPathList(arrayOfFile), new File(paramContext.getCacheDir(), "g3_grammars"), paramExecutor);
  }
  ...
  private void handleLocale(File paramFile, HashMap<String, LocaleResourcesImpl> paramHashMap)
  {
    ...
    do
    {
      ...
      {
        localLocaleResourcesImpl = new LocaleResourcesImpl(this.mEngineVersion);
