  ...
  implements Greco3DataManager.LocaleResources
{
  ...
  LocaleResourcesImpl(int paramInt)
  {
    this.mEngineVersion = paramInt;
  ...
  private String getMostRecentLanguagePackId()
  {
    ...
    while (true)
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        if ((LanguagePackUtils.isCompatible(localLanguagePack, this.mEngineVersion, 2147483647)) && (localLanguagePack.getVersion() > i))
        {
  ...
  private static GstaticConfiguration.LanguagePack parseMetadata(File paramFile)
  {
    ...
    //   0: aconst_null
    //   1: astore_1
    //   2: new 124	java/io/FileInputStream
    //   5: dup
    //   6: aload_0
    //   7: invokespecial 127	java/io/FileInputStream:<init>	(Ljava/io/File;)V
    //   10: astore_2
    //   11: aload_2
    //   12: invokestatic 133	com/google/protobuf/micro/CodedInputStreamMicro:newInstance	(Ljava/io/InputStream;)Lcom/google/protobuf/micro/CodedInputStreamMicro;
    //   15: invokestatic 137	com/google/wireless/voicesearch/proto/GstaticConfiguration$LanguagePack:parseFrom	(Lcom/google/protobuf/micro/CodedInputStreamMicro;)Lcom/google/wireless/voicesearch/proto/GstaticConfiguration$LanguagePack;
    //   18: astore 5
    //   20: aload_2
    //   21: invokestatic 143	com/google/common/io/Closeables:closeQuietly	(Ljava/io/Closeable;)V
    //   24: aload 5
    //   26: areturn
    //   27: astore 6
    //   29: aload_1
    //   30: invokestatic 143	com/google/common/io/Closeables:closeQuietly	(Ljava/io/Closeable;)V
    //   33: aconst_null
    //   34: areturn
    //   35: astore 4
    //   37: aload_1
    //   38: invokestatic 143	com/google/common/io/Closeables:closeQuietly	(Ljava/io/Closeable;)V
    //   41: aload 4
    //   43: athrow
    //   44: astore 4
    //   46: aload_2
