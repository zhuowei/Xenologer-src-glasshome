...
public final class HotwordFeature
{
  public static final class HotwordConfidenceFeature extends MessageMicro
  {
    ...
    public static final int BASELINE_FIELD_NUMBER = 6;
    ...
    public HotwordConfidenceFeature clearBaseline()
    {
    ...
    public int getSerializedSize()
    {
      ...
      if (hasBaseline())
        j += CodedOutputStreamMicro.computeBoolSize(6, getBaseline());
      if (hasNumPhones())
      ...
      throws IOException
    {
      while (true)
      {
        ...
        case 37:
          ...
          break;
        case 48:
          setBaseline(paramCodedInputStreamMicro.readBool());
          break;
        case 69:
    ...
    public HotwordConfidenceFeature setBaseline(boolean paramBoolean)
    {
      this.hasBaseline = true;
      this.baseline_ = paramBoolean;
      return this;
    }
      ...
      throws IOException
    {
      ...
      if (hasBaseline())
        paramCodedOutputStreamMicro.writeBool(6, getBaseline());
      if (hasNumPhones())
