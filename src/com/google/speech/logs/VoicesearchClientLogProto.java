...
public final class VoicesearchClientLogProto
{
  ...
  public static final class VoiceSearchClientLog extends MessageMicro
  {
    ...
    public int getSerializedSize()
    {
      ...
      if (hasIntentType())
        k += CodedOutputStreamMicro.computeInt32Size(17, getIntentType());
      this.cachedSize = k;
      return k;
    }
    ...
    public VoiceSearchClientLog setIntentType(int paramInt)
    {
      ...
      throws IOException
    {
      ...
      if (hasIntentType())
        paramCodedOutputStreamMicro.writeInt32(17, getIntentType());
    }
  }
}
