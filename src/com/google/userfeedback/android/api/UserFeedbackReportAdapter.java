    ...
    while (true)
    {
      ...
      try
      {
        ...
        case 0:
          while (true)
          {
            ...
            break;
            ((ImageView)localView.findViewById(R.id.gf_feedback_screenshot_view)).setImageBitmap(BitmapFactory.decodeByteArray(localRow.imageBytes, 0, localRow.imageBytes.length));
            break label228;
      ...
      catch (IllegalAccessException localIllegalAccessException)
      {
        while (true)
        {
          ...
          continue;
          label442: if (localRow.field.getType().equals(String.class))
          {
