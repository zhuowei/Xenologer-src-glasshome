  ...
  implements ConcurrentMap<K, V>
{
  ...
  static
  {
    ...
    {
      public LocalCache.ValueReference<Object, Object> copyFor(ReferenceQueue<Object> paramAnonymousReferenceQueue, LocalCache.ReferenceEntry<Object, Object> paramAnonymousReferenceEntry)
      {
        return this;
      }
  ...
  LocalCache(CacheBuilder<? super K, ? super V> paramCacheBuilder, CacheLoader<? super K, V> paramCacheLoader)
  {
    ...
    for (Object localObject = discardingQueue(); ; localObject = new ConcurrentLinkedQueue())
    {
      ...
      j = 0;
      k = 1;
      while ((k < this.concurrencyLevel) && ((!evictsBySize()) || (customWeigher()) || (k * 2 <= this.maxWeight)))
      {
        j++;
        k <<= 1;
      }
  ...
  ImmutableMap<K, V> getAllPresent(Iterable<? extends K> paramIterable)
  {
    int i = 0;
    int j = 0;
    LinkedHashMap localLinkedHashMap = Maps.newLinkedHashMap();
  ...
  {
    // Byte code:
    //   0: new 540	com/google/common/base/Stopwatch
    //   3: dup
    //   4: invokespecial 541	com/google/common/base/Stopwatch:<init>	()V
    //   7: invokevirtual 545	com/google/common/base/Stopwatch:start	()Lcom/google/common/base/Stopwatch;
    //   10: astore_3
    //   11: iconst_0
    //   12: istore 4
    //   14: aload_2
    //   15: aload_1
    //   16: invokevirtual 550	com/google/common/cache/CacheLoader:loadAll	(Ljava/lang/Iterable;)Ljava/util/Map;
    //   19: astore 10
    //   21: iconst_1
    //   22: ifne +19 -> 41
    //   25: aload_0
    //   26: getfield 228	com/google/common/cache/LocalCache:globalStatsCounter	Lcom/google/common/cache/AbstractCache$StatsCounter;
    //   29: aload_3
    //   30: getstatic 556	java/util/concurrent/TimeUnit:NANOSECONDS	Ljava/util/concurrent/TimeUnit;
    //   33: invokevirtual 560	com/google/common/base/Stopwatch:elapsedTime	(Ljava/util/concurrent/TimeUnit;)J
    //   36: invokeinterface 564 3 0
    //   41: aload 10
    //   43: ifnonnull +117 -> 160
    //   46: aload_0
    //   47: getfield 228	com/google/common/cache/LocalCache:globalStatsCounter	Lcom/google/common/cache/AbstractCache$StatsCounter;
    //   50: aload_3
    //   51: getstatic 556	java/util/concurrent/TimeUnit:NANOSECONDS	Ljava/util/concurrent/TimeUnit;
    //   54: invokevirtual 560	com/google/common/base/Stopwatch:elapsedTime	(Ljava/util/concurrent/TimeUnit;)J
    //   57: invokeinterface 564 3 0
    //   62: new 454	com/google/common/cache/CacheLoader$InvalidCacheLoadException
    //   65: dup
    //   66: new 456	java/lang/StringBuilder
    //   69: dup
    //   70: invokespecial 457	java/lang/StringBuilder:<init>	()V
    //   73: aload_2
    //   74: invokevirtual 466	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   77: ldc_w 566
    //   80: invokevirtual 463	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   83: invokevirtual 469	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   86: invokespecial 472	com/google/common/cache/CacheLoader$InvalidCacheLoadException:<init>	(Ljava/lang/String;)V
    //   89: athrow
    //   90: astore 9
    //   92: iconst_1
    //   93: istore 4
    ...
    //   102: ifne +19 -> 121
    //   105: aload_0
    //   106: getfield 228	com/google/common/cache/LocalCache:globalStatsCounter	Lcom/google/common/cache/AbstractCache$StatsCounter;
    //   109: aload_3
    //   110: getstatic 556	java/util/concurrent/TimeUnit:NANOSECONDS	Ljava/util/concurrent/TimeUnit;
    //   113: invokevirtual 560	com/google/common/base/Stopwatch:elapsedTime	(Ljava/util/concurrent/TimeUnit;)J
    //   116: invokeinterface 564 3 0
    //   121: aload 6
    //   123: athrow
    //   124: astore 8
    //   126: new 568	com/google/common/util/concurrent/UncheckedExecutionException
    //   129: dup
    //   130: aload 8
    //   132: invokespecial 571	com/google/common/util/concurrent/UncheckedExecutionException:<init>	(Ljava/lang/Throwable;)V
    //   135: athrow
    //   136: astore 7
    //   138: new 390	java/util/concurrent/ExecutionException
    //   141: dup
    //   142: aload 7
    //   144: invokespecial 572	java/util/concurrent/ExecutionException:<init>	(Ljava/lang/Throwable;)V
    //   147: athrow
    //   148: astore 5
    //   150: new 574	com/google/common/util/concurrent/ExecutionError
    //   153: dup
    //   154: aload 5
    //   156: invokespecial 577	com/google/common/util/concurrent/ExecutionError:<init>	(Ljava/lang/Error;)V
    //   159: athrow
    //   160: aload_3
    //   161: invokevirtual 580	com/google/common/base/Stopwatch:stop	()Lcom/google/common/base/Stopwatch;
    //   164: pop
    //   165: iconst_0
    //   166: istore 12
    //   168: aload 10
    //   170: invokeinterface 582 1 0
    //   175: invokeinterface 451 1 0
    //   180: astore 13
    //   182: aload 13
    //   184: invokeinterface 425 1 0
    //   189: ifeq +61 -> 250
    //   192: aload 13
    //   194: invokeinterface 428 1 0
    //   199: checkcast 584	java/util/Map$Entry
    //   202: astore 14
    //   204: aload 14
    //   206: invokeinterface 585 1 0
    //   211: astore 15
    //   213: aload 14
    //   215: invokeinterface 588 1 0
    //   220: astore 16
    //   222: aload 15
    //   224: ifnull +8 -> 232
    //   227: aload 16
    ...
    //   239: aload 15
    //   241: aload 16
    //   243: invokevirtual 589	com/google/common/cache/LocalCache:put	(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    //   246: pop
    //   247: goto -65 -> 182
    //   250: iload 12
    //   252: ifeq +47 -> 299
    //   255: aload_0
    //   256: getfield 228	com/google/common/cache/LocalCache:globalStatsCounter	Lcom/google/common/cache/AbstractCache$StatsCounter;
    //   259: aload_3
    //   260: getstatic 556	java/util/concurrent/TimeUnit:NANOSECONDS	Ljava/util/concurrent/TimeUnit;
    //   263: invokevirtual 560	com/google/common/base/Stopwatch:elapsedTime	(Ljava/util/concurrent/TimeUnit;)J
    //   266: invokeinterface 564 3 0
    //   271: new 454	com/google/common/cache/CacheLoader$InvalidCacheLoadException
    //   274: dup
    //   275: new 456	java/lang/StringBuilder
    //   278: dup
    //   279: invokespecial 457	java/lang/StringBuilder:<init>	()V
    //   282: aload_2
    //   283: invokevirtual 466	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   286: ldc_w 591
    //   289: invokevirtual 463	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   292: invokevirtual 469	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   295: invokespecial 472	com/google/common/cache/CacheLoader$InvalidCacheLoadException:<init>	(Ljava/lang/String;)V
    //   298: athrow
    //   299: aload_0
    //   300: getfield 228	com/google/common/cache/LocalCache:globalStatsCounter	Lcom/google/common/cache/AbstractCache$StatsCounter;
    //   303: aload_3
    //   304: getstatic 556	java/util/concurrent/TimeUnit:NANOSECONDS	Ljava/util/concurrent/TimeUnit;
    //   307: invokevirtual 560	com/google/common/base/Stopwatch:elapsedTime	(Ljava/util/concurrent/TimeUnit;)J
    //   310: invokeinterface 594 3 0
    //   315: aload 10
    //   317: areturn
    //
    // Exception table:
    //   from	to	target	type
    //   14	21	90	com/google/common/cache/CacheLoader$UnsupportedLoadingOperationException
    //   14	21	98	finally
    //   95	98	98	finally
    //   126	136	98	finally
    //   138	148	98	finally
    //   150	160	98	finally
    //   14	21	124	java/lang/RuntimeException
    //   14	21	136	java/lang/Exception
    //   14	21	148	java/lang/Error
  }
  ...
  ValueReference<K, V> newValueReference(ReferenceEntry<K, V> paramReferenceEntry, V paramV, int paramInt)
  {
    ...
    return this.valueStrength.referenceValue(segmentFor(i), paramReferenceEntry, paramV, paramInt);
  }
  ...
  {
    int i = hash(Preconditions.checkNotNull(paramK));
    segmentFor(i).refresh(paramK, i, this.defaultLoader);
  }
    ...
    implements LocalCache.ValueReference<K, V>
  {
    ...
    public LocalCache.ValueReference<K, V> copyFor(ReferenceQueue<V> paramReferenceQueue, LocalCache.ReferenceEntry<K, V> paramReferenceEntry)
    {
      return this;
    }
    ...
    implements LoadingCache<K, V>
  {
    ...
    {
      super((CacheLoader)Preconditions.checkNotNull(paramCacheLoader));
    }
    ...
    implements Cache<K, V>, Serializable
  {
    ...
    {
      this(paramCacheBuilder, null);
    }

    protected LocalManualCache(CacheBuilder<? super K, ? super V> paramCacheBuilder, CacheLoader<? super K, V> paramCacheLoader)
    {
      this.localCache = new LocalCache(paramCacheBuilder, paramCacheLoader);
    }
    ...
    {
      return this.localCache.getIfPresent(paramK);
    }
  ...
  static class Segment<K, V> extends ReentrantLock
  {
    ...
    Segment(LocalCache<K, V> paramLocalCache, int paramInt, long paramLong, AbstractCache.StatsCounter paramStatsCounter)
    {
      ...
      if (paramLocalCache.usesKeyReferences())
      {
        ...
        label129: this.writeQueue = ((Queue)localObject2);
        if (!paramLocalCache.usesAccessQueue())
          break label180;
      }
      label164: label172: label180: for (Object localObject3 = new LocalCache.AccessQueue(); ; localObject3 = LocalCache.discardingQueue())
      {
    ...
    void expand()
    {
      ...
      while (m < i)
      {
        ...
        while (true)
        {
          ...
          localAtomicReferenceArray2.set(i2, copyEntry(localReferenceEntry4, (LocalCache.ReferenceEntry)localAtomicReferenceArray2.get(i2)));
        }
      }
    ...
    @Nullable
    LocalCache.LoadingValueReference<K, V> insertLoadingValueReference(K paramK, int paramInt)
    {
      lock();
      try
      {
        ...
        for (LocalCache.ReferenceEntry localReferenceEntry2 = localReferenceEntry1; localReferenceEntry2 != null; localReferenceEntry2 = localReferenceEntry2.getNext())
        {
          ...
          if ((localReferenceEntry2.getHash() == paramInt) && (localObject2 != null) && (this.map.keyEquivalence.equivalent(paramK, localObject2)))
          {
            ...
            boolean bool = localValueReference.isLoading();
            if (bool)
              return null;
            this.modCount = (1 + this.modCount);
    ...
    boolean isCollected(LocalCache.ReferenceEntry<K, V> paramReferenceEntry)
    {
      if (paramReferenceEntry.getKey() == null);
      ...
      while ((localValueReference.get() == null) && (localValueReference.isActive()));
      return false;
    }
      ...
      throws ExecutionException
    {
      ...
      //   1: istore 4
      //   3: aload_0
      //   4: invokevirtual 124	com/google/common/cache/LocalCache$Segment:lock	()V
      //   7: aload_0
      //   8: getfield 47	com/google/common/cache/LocalCache$Segment:map	Lcom/google/common/cache/LocalCache;
      //   11: getfield 105	com/google/common/cache/LocalCache:ticker	Lcom/google/common/base/Ticker;
      //   14: invokevirtual 111	com/google/common/base/Ticker:read	()J
      //   17: lstore 6
      //   19: aload_0
      //   20: lload 6
      //   22: invokevirtual 478	com/google/common/cache/LocalCache$Segment:preWriteCleanup	(J)V
      //   25: iconst_m1
      //   26: aload_0
      //   27: getfield 121	com/google/common/cache/LocalCache$Segment:count	I
      //   30: iadd
      //   31: istore 8
      //   33: aload_0
      //   34: getfield 126	com/google/common/cache/LocalCache$Segment:table	Ljava/util/concurrent/atomic/AtomicReferenceArray;
      //   37: astore 9
      //   39: iload_2
      //   40: iconst_m1
      //   41: aload 9
      //   43: invokevirtual 132	java/util/concurrent/atomic/AtomicReferenceArray:length	()I
      //   46: iadd
      //   47: iand
      //   48: istore 10
      //   50: aload 9
      //   52: iload 10
      //   54: invokevirtual 136	java/util/concurrent/atomic/AtomicReferenceArray:get	(I)Ljava/lang/Object;
      //   57: checkcast 138	com/google/common/cache/LocalCache$ReferenceEntry
      //   60: astore 11
      //   62: aload 11
      //   64: astore 12
      //   66: aconst_null
      ...
      //   71: ifnull +66 -> 137
      //   74: aload 12
      //   76: invokeinterface 267 1 0
      //   81: astore 14
      //   83: aload 12
      //   85: invokeinterface 270 1 0
      //   90: iload_2
      ...
      //   103: getfield 455	com/google/common/cache/LocalCache:keyEquivalence	Lcom/google/common/base/Equivalence;
      //   106: aload_1
      //   107: aload 14
      //   109: invokevirtual 222	com/google/common/base/Equivalence:equivalent	(Ljava/lang/Object;Ljava/lang/Object;)Z
      //   112: ifeq +260 -> 372
      //   115: aload 12
      //   117: invokeinterface 142 1 0
      //   122: astore 13
      //   124: aload 13
      //   126: invokeinterface 373 1 0
      //   131: ifeq +103 -> 234
      //   134: iconst_0
      //   135: istore 4
      //   137: aconst_null
      ...
      //   140: iload 4
      //   142: ifeq +49 -> 191
      //   145: new 431	com/google/common/cache/LocalCache$LoadingValueReference
      //   148: dup
      //   149: invokespecial 481	com/google/common/cache/LocalCache$LoadingValueReference:<init>	()V
      //   152: astore 17
      //   154: aload 12
      ...
      //   161: iload_2
      //   162: aload 11
      //   164: invokevirtual 485	com/google/common/cache/LocalCache$Segment:newEntry	(Ljava/lang/Object;ILcom/google/common/cache/LocalCache$ReferenceEntry;)Lcom/google/common/cache/LocalCache$ReferenceEntry;
      //   167: astore 12
      //   169: aload 12
      //   171: aload 17
      ...
      //   180: iload 10
      //   182: aload 12
      //   184: invokevirtual 165	java/util/concurrent/atomic/AtomicReferenceArray:set	(ILjava/lang/Object;)V
      //   187: aload 17
      //   189: astore 16
      //   191: aload_0
      //   192: invokevirtual 180	com/google/common/cache/LocalCache$Segment:unlock	()V
      //   195: aload_0
      //   196: invokevirtual 183	com/google/common/cache/LocalCache$Segment:postWriteCleanup	()V
      //   199: iload 4
      //   201: ifeq +226 -> 427
      //   204: aload 12
      //   206: monitorenter
      ...
      //   210: aload 16
      //   212: aload_3
      //   213: invokevirtual 512	com/google/common/cache/LocalCache$Segment:loadSync	(Ljava/lang/Object;ILcom/google/common/cache/LocalCache$LoadingValueReference;Lcom/google/common/cache/CacheLoader;)Ljava/lang/Object;
      //   216: astore 20
      //   218: aload 12
      //   220: monitorexit
      //   221: aload_0
      //   222: getfield 51	com/google/common/cache/LocalCache$Segment:statsCounter	Lcom/google/common/cache/AbstractCache$StatsCounter;
      //   225: iconst_1
      //   226: invokeinterface 515 2 0
      //   231: aload 20
      //   233: areturn
      //   234: aload 13
      //   236: invokeinterface 205 1 0
      //   241: astore 21
      //   243: aload 21
      //   245: ifnonnull +65 -> 310
      //   248: getstatic 518	com/google/common/cache/RemovalCause:COLLECTED	Lcom/google/common/cache/RemovalCause;
      //   251: astore 22
      //   253: aload_0
      //   254: aload 14
      //   256: iload_2
      //   257: aload 13
      //   259: aload 22
      //   261: invokevirtual 273	com/google/common/cache/LocalCache$Segment:enqueueNotification	(Ljava/lang/Object;ILcom/google/common/cache/LocalCache$ValueReference;Lcom/google/common/cache/RemovalCause;)V
      //   264: aload_0
      //   265: getfield 91	com/google/common/cache/LocalCache$Segment:writeQueue	Ljava/util/Queue;
      //   268: aload 12
      //   270: invokeinterface 521 2 0
      //   275: pop
      //   276: aload_0
      //   277: getfield 96	com/google/common/cache/LocalCache$Segment:accessQueue	Ljava/util/Queue;
      //   280: aload 12
      //   282: invokeinterface 521 2 0
      //   287: pop
      //   288: aload_0
      //   289: iload 8
      //   291: putfield 121	com/google/common/cache/LocalCache$Segment:count	I
      //   294: goto -157 -> 137
      //   297: astore 5
      //   299: aload_0
      //   300: invokevirtual 180	com/google/common/cache/LocalCache$Segment:unlock	()V
      //   303: aload_0
      //   304: invokevirtual 183	com/google/common/cache/LocalCache$Segment:postWriteCleanup	()V
      //   307: aload 5
      //   309: athrow
      //   310: aload_0
      ...
      //   314: aload 12
      //   316: lload 6
      //   318: invokevirtual 341	com/google/common/cache/LocalCache:isExpired	(Lcom/google/common/cache/LocalCache$ReferenceEntry;J)Z
      //   321: ifeq +22 -> 343
      //   324: getstatic 344	com/google/common/cache/RemovalCause:EXPIRED	Lcom/google/common/cache/RemovalCause;
      //   327: astore 25
      //   329: aload_0
      //   330: aload 14
      //   332: iload_2
      //   333: aload 13
      //   335: aload 25
      //   337: invokevirtual 273	com/google/common/cache/LocalCache$Segment:enqueueNotification	(Ljava/lang/Object;ILcom/google/common/cache/LocalCache$ValueReference;Lcom/google/common/cache/RemovalCause;)V
      //   340: goto -76 -> 264
      //   343: aload_0
      //   344: aload 12
      //   346: lload 6
      //   348: invokevirtual 524	com/google/common/cache/LocalCache$Segment:recordLockedRead	(Lcom/google/common/cache/LocalCache$ReferenceEntry;J)V
      //   351: aload_0
      //   352: getfield 51	com/google/common/cache/LocalCache$Segment:statsCounter	Lcom/google/common/cache/AbstractCache$StatsCounter;
      //   355: iconst_1
      //   356: invokeinterface 370 2 0
      //   361: aload_0
      //   362: invokevirtual 180	com/google/common/cache/LocalCache$Segment:unlock	()V
      //   365: aload_0
      //   366: invokevirtual 183	com/google/common/cache/LocalCache$Segment:postWriteCleanup	()V
      //   369: aload 21
      //   371: areturn
      //   372: aload 12
      //   374: invokeinterface 161 1 0
      //   379: astore 15
      //   381: aload 15
      //   383: astore 12
      //   385: goto -319 -> 66
      ...
      //   412: astore 18
      //   414: aload_0
      //   415: getfield 51	com/google/common/cache/LocalCache$Segment:statsCounter	Lcom/google/common/cache/AbstractCache$StatsCounter;
      //   418: iconst_1
      //   419: invokeinterface 515 2 0
      //   424: aload 18
      //   426: athrow
      //   427: aload_0
      //   428: aload 12
      //   430: aload_1
      //   431: aload 13
      //   433: invokevirtual 377	com/google/common/cache/LocalCache$Segment:waitForLoadingValue	(Lcom/google/common/cache/LocalCache$ReferenceEntry;Ljava/lang/Object;Lcom/google/common/cache/LocalCache$ValueReference;)Ljava/lang/Object;
      //   436: areturn
      //   437: astore 5
      //   439: goto -140 -> 299
      //
    ...
    @Nullable
    V refresh(K paramK, int paramInt, CacheLoader<? super K, V> paramCacheLoader)
    {
      LocalCache.LoadingValueReference localLoadingValueReference = insertLoadingValueReference(paramK, paramInt);
      ...
      try
      {
        Object localObject = localListenableFuture.get();
        return localObject;
      }
      catch (Throwable localThrowable)
      {
    ...
    LocalCache.ReferenceEntry<K, V> removeEntryFromChain(LocalCache.ReferenceEntry<K, V> paramReferenceEntry1, LocalCache.ReferenceEntry<K, V> paramReferenceEntry2)
    {
      ...
      {
        if (isCollected((LocalCache.ReferenceEntry)localObject))
        {
          removeCollectedEntry((LocalCache.ReferenceEntry)localObject);
          i--;
        }
        while (true)
        {
          ...
          break;
          localReferenceEntry = copyEntry((LocalCache.ReferenceEntry)localObject, localReferenceEntry);
        }
      }
      this.count = i;
      return localReferenceEntry;
    ...
    V scheduleRefresh(LocalCache.ReferenceEntry<K, V> paramReferenceEntry, K paramK, int paramInt, V paramV, long paramLong, CacheLoader<? super K, V> paramCacheLoader)
    {
      ...
      {
        Object localObject = refresh(paramK, paramInt, paramCacheLoader);
        if (localObject != null)
          return localObject;
      }
      return paramV;
      ...
      try
      {
        ...
        for (LocalCache.ReferenceEntry localReferenceEntry2 = localReferenceEntry1; localReferenceEntry2 != null; localReferenceEntry2 = localReferenceEntry2.getNext())
        {
          ...
          if ((localReferenceEntry2.getHash() == paramInt) && (localObject2 != null) && (this.map.keyEquivalence.equivalent(paramK, localObject2)))
          {
            LocalCache.ValueReference localValueReference = localReferenceEntry2.getValueReference();
            Object localObject3 = localValueReference.get();
            if ((localObject3 == null) || (paramLoadingValueReference == localValueReference))
            {
              this.modCount = (1 + this.modCount);
              if (paramLoadingValueReference.isActive())
                if (localObject3 != null)
                  break label208;
              label208: for (RemovalCause localRemovalCause = RemovalCause.COLLECTED; ; localRemovalCause = RemovalCause.REPLACED)
              {
  ...
  {
    public abstract ValueReference<K, V> copyFor(ReferenceQueue<V> paramReferenceQueue, LocalCache.ReferenceEntry<K, V> paramReferenceEntry);
  ...
  static final class WeightedSoftValueReference<K, V> extends LocalCache.SoftValueReference<K, V>
  {
    ...
    public LocalCache.ValueReference<K, V> copyFor(ReferenceQueue<V> paramReferenceQueue, LocalCache.ReferenceEntry<K, V> paramReferenceEntry)
    {
      return new WeightedSoftValueReference(paramReferenceQueue, get(), paramReferenceEntry, this.weight);
    }
  ...
  static final class WeightedWeakValueReference<K, V> extends LocalCache.WeakValueReference<K, V>
  {
    ...
    public LocalCache.ValueReference<K, V> copyFor(ReferenceQueue<V> paramReferenceQueue, LocalCache.ReferenceEntry<K, V> paramReferenceEntry)
    {
      return new WeightedWeakValueReference(paramReferenceQueue, get(), paramReferenceEntry, this.weight);
    }
