...
{
  static final Supplier<AbstractCache.SimpleStatsCounter> CACHE_STATS_COUNTER = new Supplier()
  {
  ...
  Supplier<? extends AbstractCache.StatsCounter> statsCounterSupplier = CACHE_STATS_COUNTER;
  ...
  public String toString()
  {
    ...
    while (true)
    {
      ...
      label259: localToStringHelper.add("maximumWeight", this.maximumWeight);
    }
  }
