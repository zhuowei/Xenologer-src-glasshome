...
public final class GstaticConfiguration
{
  ...
  public static final class LanguagePack extends MessageMicro
  {
    ...
    public LanguagePack addCompatibleEngineVersions(int paramInt)
    {
      if (this.compatibleEngineVersions_.isEmpty())
        this.compatibleEngineVersions_ = new ArrayList();
      this.compatibleEngineVersions_.add(Integer.valueOf(paramInt));
      return this;
    }
    ...
    public int getCompatibleEngineVersions(int paramInt)
    {
      return ((Integer)this.compatibleEngineVersions_.get(paramInt)).intValue();
    }
    ...
    public int getSerializedSize()
    {
      ...
      int m = 0;
      Iterator localIterator2 = getCompatibleEngineVersionsList().iterator();
      while (localIterator2.hasNext())
        m += CodedOutputStreamMicro.computeInt32SizeNoTag(((Integer)localIterator2.next()).intValue());
      int n = k + m + 1 * getCompatibleEngineVersionsList().size();
      ...
      throws IOException
    {
      while (true)
      {
        ...
        case 50:
          ...
          break;
        case 56:
          addCompatibleEngineVersions(paramCodedInputStreamMicro.readInt32());
          break;
        case 64:
        }
    ...
    public LanguagePack setCompatibleEngineVersions(int paramInt1, int paramInt2)
    {
      this.compatibleEngineVersions_.set(paramInt1, Integer.valueOf(paramInt2));
      return this;
    }
